const firebaseConfig = {
  ...
  function submitForm(e) {
    ...
    var name5 = getElementVal("name5");
    var name6 = getElementVal("name6");
    // var emailid = getElementVal("emailid");
    // var msgContent = getElementVal("msgContent");
    
  
    saveMessages(name, name2, name3,name4,name5,name6);
  ...
  const saveMessages = (name, name2, name3,name4,name5,name6) => {
